...
public class KeyValueList<E> {
  ...
  /*Complete o método toString(left, sep, right) da classe KeyValueList que deve
 devolver uma representação da lista como uma sequência de pares (chave, valor)
 * separados entre si pela string sep e delimitada pelas strings left e right. Verifique
 o resultado das invocações no programa.*/
