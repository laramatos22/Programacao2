...
public class HashTable<E> {
  ...
  /*toString() - Devolve uma representação da tabela de dispersão em cadeia de carac-
teres de acordo com o seguinte formato: {(k 1 , e 1 ), ..., (k n , e n )}. Dica: poderá invocar
o toString generalizado para obter os elementos de cada KeyValueList.*/
