...
public class JogoDoGalo {
  ...
  public char ultimoJogador() { return ultimoJogador; }
  ...
  public int jogadaValida(int lin, int col) {
    return coordValidas(lin, col) && posicaoVazia(lin, col) && !terminado();
  }

  private boolean ultimoJogadorGanhou() {
  ...
  public void printScores() {
	  ...
	  out.printf("   X   |   %2d  |  %2d  |  %2s	\n", vitoriasX, vitoriasY, empates);
	  out.printf("   X   |   %2d  |  %2d  |  %2s	\n", vitoriasY, vitoriasX, empates);
  }
  
  private static int numHogos=1;
  private static int vitoriasX = 0;
  private static int vitoriasY=0;
