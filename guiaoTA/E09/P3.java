/*Construa uma função recursiva – isPrefix – que recebendo (pelo menos) dois Strings
como argumentos, indica se a segunda string é um prefixo da primeira.
Para testar a função crie um programa – P3.java – que aplique a função a todos os
seus argumentos (dois a dois, pelo que o número de argumentos deve ser par).*/
